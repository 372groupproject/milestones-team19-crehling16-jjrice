...
### CONSTRUCTORS ###
The file p4_constructors.lg contians fours code snippets displaying the four library provided constructor methods: MDARRAY, COMBINE, REVERSE, and GENSYM. The output of the file is seperated into four sections, seperating each code snippet into its own section.

* MDARRAY [int1 int2]
  * Outputs a multi-dimensional array where the first integer in the input list, int1, specifies the number of elements in the array and the secodn interger, int2, specifies how many elements are in each nested array.

* COMBINE thing1 thing2
  * if thing2 is a word, outputs WORD thing1 thing2.  If thing2 is a list, outputs FPUT thing1 thing2 (UCBLogo manual). 
